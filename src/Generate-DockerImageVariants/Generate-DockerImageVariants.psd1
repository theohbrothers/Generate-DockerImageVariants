...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'generate-dockerimagevariants','continuous-deployment','continuous-integration','docker','docker-image','generator','module','powershell','pwsh','repository','template','template-engine','variants'
